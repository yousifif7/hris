...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <div class="nav-section"><div class="nav-section-title">Recruitment</div>
      ...
      <a href="{{ route('hris.screening') }}" class="nav-item {{ request()->routeIs('hris.screening') ? 'active' : '' }}" data-page="screening"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22,4 12,14.01 9,11.01"/></svg>Screening & Checks</a>
      <a href="{{ route('hris.offers') }}" class="nav-item {{ request()->routeIs('hris.offers') ? 'active' : '' }}" data-page="offers"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14,2 14,8 20,8"/></svg>Offers</a>
    </div>
    <div class="nav-section"><div class="nav-section-title">People</div>
      <a href="{{ route('hris.onboarding') }}" class="nav-item {{ request()->routeIs('hris.onboarding') ? 'active' : '' }}" data-page="onboarding"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="8.5" cy="7" r="4"/><polyline points="17,11 19,13 23,9"/></svg>Onboarding</a>
    ...
    <div class="nav-section"><div class="nav-section-title">System</div>
      <a href="{{ route('hris.messaging') }}" class="nav-item {{ request()->routeIs('hris.messaging') ? 'active' : '' }}" data-page="messaging"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>Email Inbox</a>
      <a href="{{ route('hris.sms') }}" class="nav-item {{ request()->routeIs('hris.sms') ? 'active' : '' }}" data-page="sms"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>SMS</a>
