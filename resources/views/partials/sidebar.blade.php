...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <div class="nav-section"><div class="nav-section-title">Recruitment Sequence</div>
      <a href="{{ route('hris.new-candidates') }}" class="nav-item {{ request()->routeIs('hris.new-candidates') ? 'active' : '' }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/></svg>Pre-Screening</a>
      <a href="{{ route('hris.review') }}" class="nav-item {{ request()->routeIs('hris.review') ? 'active' : '' }}" data-page="review"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14,2 14,8 20,8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>Pre-Interview Questions <span class="nav-badge" id="reviewBadge">0</span></a>
      <a href="{{ route('hris.screening') }}" class="nav-item {{ request()->routeIs('hris.screening') ? 'active' : '' }}" data-page="screening"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22,4 12,14.01 9,11.01"/></svg>Verification and Review</a>
      ...
      <a href="{{ route('hris.workflow.dwc_training') }}" class="nav-item {{ request()->routeIs('hris.workflow.dwc_training') ? 'active' : '' }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M12 4h9"/><path d="M4 9h16"/><path d="M4 15h16"/></svg>DWC Trainings</a>
