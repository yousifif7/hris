...
:root{--accent:#5b4cdb;--accent2:#7b68ee;--bg:#f4f5f7;--surface:#fff;--border:#dfe1e6;--text:#172b4d;--text2:#5e6c84;--text3:#97a0af;--red:#de350b;--radius:8px;--font:'DM Sans',sans-serif;--font-display:'Playfair Display',serif}
...
.form-group input:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(91,76,219,.1)}
...
.btn:hover{background:#4a3cc5;transform:translateY(-1px);box-shadow:0 2px 8px rgba(91,76,219,.3)}
...
<body>
<div class="card">
    <div class="logo"><div class="icon">TF</div><h1>TalentFlow</h1></div>
...
<?php /**PATH F:\laravel projects\hrportal\resources\views\auth\login.blade.php ENDPATH**/ ?>