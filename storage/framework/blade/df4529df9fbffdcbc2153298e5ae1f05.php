...
<?php $__env->startSection('title','TalentFlow — Dashboard'); ?>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;animation-delay:.15s" class="animate-in">
  <div class="table-wrap">
    <div class="table-header"><h3>Recent Candidates</h3><a href="<?php echo e(route('hris.review')); ?>" class="btn btn-secondary btn-sm">Review Queue →</a></div>
  ...
  <div class="table-wrap">
    <div class="table-header"><h3>Upcoming Interviews</h3><a href="<?php echo e(route('hris.interviews')); ?>" class="btn btn-secondary btn-sm">All →</a></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel projects\hrportal\resources\views\hris\dashboard.blade.php ENDPATH**/ ?>